namespace Remote
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Manual TCP Connect";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// btnTcpDisconnect
			// 
			this.btnTcpDisconnect.Location = new System.Drawing.Point(634, 128);
			this.btnTcpDisconnect.Name = "btnTcpDisconnect";
			this.btnTcpDisconnect.Size = new System.Drawing.Size(104, 55);
			this.btnTcpDisconnect.TabIndex = 12;
